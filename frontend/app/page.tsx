  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8">
        <div className="mb-8 rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-8">
          ...
          <p className="mt-4 max-w-3xl text-slate-300">
            Ask college questions, upload university PDFs, simplify difficult
            regulations, get career guidance, analyze resumes, and predict
            academic risks.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a
              href="/career"
              className="rounded-lg bg-cyan-600 px-5 py-3 text-sm font-semibold text-white hover:bg-cyan-700"
            >
              Career Engine
            </a>
        ...
        <div className="mb-4 grid gap-4 md:grid-cols-3">
          <FeatureCard
            title="AI Chatbot"
            description="Explain backlogs, attendance, CGPA, electives, placements, and scholarships."
          />
          <FeatureCard
            title="University PDF RAG"
            description="Upload regulations and ask questions based only on the document."
          />
          <FeatureCard
            title="PDF Simplifier"
            description="Convert difficult academic rules into simple student or parent-friendly language."
          />
        </div>
        ...
        <div className="mb-4 rounded-2xl border border-slate-800 bg-slate-900 p-4">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${appMode === "general"
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${appMode === "rag"
                  ? "bg-blue-600 text-white"
                  : "bg-slate-800 text-slate-300"
                }`}
            >
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${appMode === "simplify"
                  ? "bg-blue-600 text-white"
                  : "bg-slate-800 text-slate-300"
                }`}
            >
              ...
              {messages.length === 0 ? (
                ...
                <div className="space-y-4">
                  {messages.map((chat, index) => (
                    <div
                      key={index}
                      className={`rounded-xl p-4 ${chat.role === "user"
